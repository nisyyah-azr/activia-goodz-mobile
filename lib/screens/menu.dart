...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Nisyyah Azzahra"; //nama
  final String npm = "2406495823"; //npm
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Activia Goodz" dengan teks putih dan tebal.
        title: const Text(
          'Activia Goodz',
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Activia Goodz',
                      style: TextStyle(
